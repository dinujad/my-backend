...
<div x-data="productForm()" class="pb-20">
    <div class="flex items-center justify-between gap-3 mb-6">
        <div class="flex items-center gap-3">
            <a href="{{ route('admin.products.index') }}" class="text-gray-500 hover:text-gray-800"><i class="bi bi-arrow-left"></i></a>
            <h1 class="text-2xl font-bold text-gray-900">Add New Product</h1>
        </div>
        <div class="flex gap-2">
            <button type="button" @click="saveDraft" class="px-4 py-2 border border-gray-300 rounded-lg text-sm font-medium hover:bg-gray-50 transition">
                Save Draft
            </button>
            <button type="button" @click="$refs.mainForm.submit()" class="px-4 py-2 bg-brand-red text-white rounded-lg text-sm font-medium hover:bg-red-dark transition flex items-center gap-2">
                <i class="bi bi-check2"></i> Publish Product
            </button>
        </div>
    </div>
    ...
    <form x-ref="mainForm" action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-col lg:flex-row gap-6">
        @csrf
        ...
        <div class="flex-1 space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 space-y-4">
                ...
                <div>
                    ...
                    <div class="flex items-center bg-gray-50 border border-gray-200 rounded-lg px-3 p-1">
                        <span class="text-gray-400 text-sm mr-1">{{ url('/') }}/product/</span>
                ...
                <div>
                    ...
                    <div class="text-xs text-right text-gray-400" x-text="shortDesc.length + ' / 500'"></div>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Full Description</label>
                    <textarea name="description" rows="8"
                              class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:border-brand-red outline-none">{{ old('description') }}</textarea>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="bg-gray-50 border-b border-gray-100 p-3 flex flex-wrap items-center gap-4">
                    ...
                    <div class="flex items-center gap-3 ml-auto mr-2 text-sm">
                        <label class="flex items-center gap-1.5 cursor-pointer text-gray-600">
                            <input type="checkbox" name="is_virtual" value="1" class="rounded border-gray-300 text-brand-red focus:ring-brand-red"> Virtual
                        </label>
                        <label class="flex items-center gap-1.5 cursor-pointer text-gray-600">
                            <input type="checkbox" name="is_downloadable" value="1" class="rounded border-gray-300 text-brand-red focus:ring-brand-red"> Downloadable
                        </label>
                    </div>
                </div>
                ...
                <div class="flex flex-col md:flex-row min-h-[400px]">
                    ...
                    <div class="flex-1 p-5 lg:p-6 bg-white space-y-5">
                        ...
                        <div x-show="tab === 'inventory'" style="display: none;" x-transition.opacity>
                            <div class="space-y-4 max-w-lg">
                                <div class="flex items-center gap-4">
                                    ...
                                    <input type="text" name="sku" class="w-2/3 border border-gray-200 rounded-md px-3 py-1.5 font-mono text-sm focus:border-brand-red outline-none">
                                </div>
                                <div class="flex items-center gap-4">
                                ...
                                <div class="flex items-center gap-4" x-show="manageStock">
                                    ...
                                    <input type="number" name="stock_quantity" class="w-2/3 border border-gray-200 rounded-md px-3 py-1.5 focus:border-brand-red outline-none" min="0">
                                </div>
                                <div class="flex items-center gap-4" x-show="manageStock">
                                    <label class="w-1/3 text-sm text-gray-600 font-medium">Low stock threshold</label>
                                    <input type="number" name="low_stock_threshold" class="w-2/3 border border-gray-200 rounded-md px-3 py-1.5 focus:border-brand-red outline-none" min="0" value="2">
                                </div>
                                <div class="flex items-center gap-4" x-show="!manageStock">
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <div class="w-2/3">
                                        <input type="number" name="min_purchase" min="1" value="{{ old('min_purchase', 1) }}" class="w-full border border-gray-200 rounded-md px-3 py-1.5 focus:border-brand-red outline-none" placeholder="e.g. 10">
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <div class="w-2/3">
                                        <input type="number" name="max_purchase" min="1" value="{{ old('max_purchase') }}" class="w-full border border-gray-200 rounded-md px-3 py-1.5 focus:border-brand-red outline-none" placeholder="Optional">
                        ...
                        <div x-show="tab === 'shipping'" style="display: none;" x-transition.opacity>
                            <div class="space-y-4 max-w-lg">
                                <div class="flex items-center gap-4">
                                    ...
                                    <input type="number" step="0.001" name="weight" class="w-2/3 border border-gray-200 rounded-md px-3 py-1.5 focus:border-brand-red outline-none">
                                </div>
                                <div class="flex items-start gap-4">
                                    ...
                                    <div class="w-2/3 flex gap-2">
                                        <input type="number" step="0.1" name="length" placeholder="Length" class="w-1/3 border border-gray-200 rounded-md px-2 py-1.5 text-sm focus:border-brand-red outline-none">
                                        <input type="number" step="0.1" name="width" placeholder="Width" class="w-1/3 border border-gray-200 rounded-md px-2 py-1.5 text-sm focus:border-brand-red outline-none">
                                        <input type="number" step="0.1" name="height" placeholder="Height" class="w-1/3 border border-gray-200 rounded-md px-2 py-1.5 text-sm focus:border-brand-red outline-none">
                                    </div>
                                </div>
                                <div class="flex items-center gap-4">
                                ...
                                <div class="flex items-center gap-4 pt-4">
                                    ...
                                    <label class="w-2/3 flex items-center gap-2 cursor-pointer text-gray-700 text-sm">
                                        <input type="checkbox" name="is_fragile" value="1" class="rounded border-gray-300 text-brand-red focus:ring-brand-red"> 
                        ...
                        {{-- Payment Methods restriction inside Shipping tab --}}
                        @php $allPaymentMethods = \App\Models\PaymentMethod::orderBy('sort_order')->get(); @endphp
                        ...
                        <div class="pt-4 border-t border-gray-100 mt-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <label class="flex items-center gap-3 cursor-pointer py-1">
                                    <input type="checkbox" name="payment_method_ids[]" value="{{ $pm->id }}"
                                           {{ in_array($pm->id, old('payment_method_ids', [])) ? 'checked' : '' }}
                                           class="h-4 w-4 rounded border-gray-300 text-brand-red focus:ring-brand-red">
                                    <span class="text-sm text-gray-700">{{ $pm->name }}</span>
                                    <span class="text-xs rounded-full px-2 py-0.5 {{ $pm->type === 'online' ? 'bg-blue-100 text-blue-600' : 'bg-gray-100 text-gray-500' }}">{{ ucfirst($pm->type) }}</span>
                                </label>
                                @endforeach
                            </div>
                        </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div x-show="variationsEnabled" class="flex justify-between items-center bg-gray-50 p-3 rounded-lg border border-gray-200">
                                    ...
                                    <button type="button" @click="generateVariations" class="px-3 py-1.5 bg-gray-200 hover:bg-gray-300 text-sm font-medium rounded text-gray-700 transition" :disabled="isGeneratingVariations">
                                        <span x-show="!isGeneratingVariations">Go</span>
                                        <span x-show="isGeneratingVariations">Loading...</span>
                                    </button>
                                </div>

                                <div class="space-y-3 mt-4">
                                    <template x-for="(variation, vIndex) in variations" :key="variation.temp_key || ('var_'+vIndex)">
                                        <div class="border border-gray-200 rounded-lg bg-white overflow-hidden shadow-sm" x-data="{ expanded: false }">
                                            <div class="flex items-center justify-between px-4 py-3 bg-gray-50 border-b border-gray-100 cursor-pointer" @click="expanded = !expanded">
                                                <div class="flex items-center gap-4">
                                                    ...
                                                    <span class="font-bold text-gray-700 font-mono text-sm">
                                                        #<span x-text="vIndex + 1"></span> &nbsp;&mdash;&nbsp; 
                                            ...
                                            <div class="p-4 grid grid-cols-1 md:grid-cols-2 gap-4 bg-white" x-show="expanded" x-collapse>
                                                ...
                                                <!-- Variation Form Fields mapping to JSON for POST request -->
                                        ...
                                        <div class="border-t border-gray-200 pt-4 mt-2 space-y-3">
                                            <label class="flex items-start gap-3 cursor-pointer text-gray-700 text-sm" @click.prevent="custSettings.use_popup = !custSettings.use_popup">
                                                ...
                                                <span>
                                                    ...
                                                    <span class="text-xs text-gray-500 leading-snug block mt-0.5">Storefront eke form popup eken open. Flat fee total eka athulata.</span>
                                                </span>
                                            </label>
                                            <div x-show="custSettings.use_popup" x-transition class="pl-7 space-y-1">
                                                ...
                                                <input type="text" name="customization_settings[popup_button_label]" x-model="custSettings.popup_button_label" class="w-full max-w-md border border-gray-200 rounded px-3 py-1.5 text-sm focus:border-brand-red outline-none bg-white" placeholder="e.g. Add artwork & details">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div x-show="tab === 'advanced'" style="display: none;" x-transition.opacity>
                            <div class="space-y-4 max-w-lg">
                                <div>
                                    ...
                                    <textarea name="purchase_note" rows="2" class="w-full border border-gray-200 rounded-md px-3 py-2 text-sm focus:border-brand-red outline-none"></textarea>
                                </div>
                                <div class="flex items-center gap-4">
                                    <label class="w-1/3 text-sm text-gray-600 font-medium">Menu order</label>
                                    <input type="number" name="sort_order" class="w-2/3 border border-gray-200 rounded-md px-3 py-1.5 focus:border-brand-red outline-none" value="0">
                                </div>
                                <div class="pt-2">
                                    <label class="flex items-center gap-2 cursor-pointer text-gray-700 text-sm font-medium">
                                        <input type="checkbox" name="enable_reviews" value="1" checked class="rounded border-gray-300 text-brand-red focus:ring-brand-red h-4 w-4">
                                        Enable reviews
                                    </label>
                                </div>
                            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 space-y-4">
                ...
                <div class="p-4 bg-gray-50 rounded-lg border border-gray-200 font-sans">
                    <div class="text-xs text-gray-500 mb-2 truncate">{{ url('/') }} › product › <span x-text="slug || 'new-product'"></span></div>
                ...
                <div class="grid grid-cols-1 gap-4">
                    <div>
                        <div class="flex justify-between items-end mb-1">
                            ...
                            <span class="text-xs" :class="seoTitle.length > 60 ? 'text-red-500' : 'text-gray-400'" x-text="seoTitle.length + ' / 60'"></span>
                        </div>
                    ...
                    <div>
                        <div class="flex justify-between items-end mb-1">
                            ...
                            <span class="text-xs" :class="seoDesc.length > 160 ? 'text-red-500' : 'text-gray-400'" x-text="seoDesc.length + ' / 160'"></span>
                        </div>
        ...
        <div class="w-full lg:w-80 shrink-0 space-y-6">
            ...
            <!-- Publish Setup -->
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 space-y-4">
                <h2 class="font-semibold text-gray-800 pb-2 border-b border-gray-100">Publish</h2>
                ...
                <div class="space-y-3 text-sm text-gray-700">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <select name="visibility" class="border border-gray-200 rounded px-2 py-1 outline-none focus:border-brand-red font-medium">
                            <option value="shop_search">Catalog & Search</option>
                            <option value="shop_only">Catalog only</option>
                ...
                <div class="pt-2 border-t border-gray-100">
                    <button type="submit" class="w-full py-2.5 bg-brand-red text-white text-sm font-semibold rounded-lg hover:bg-red-dark transition shadow-sm">
                        Publish Let's Go
                    </button>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 space-y-3">
                ...
                <p class="text-xs text-gray-500">Special Offer = left sidebar (max 2). Other ticks control Featured / On Sale / Top Rated tabs.</p>
                <label class="flex items-center gap-2 text-sm cursor-pointer">
                    <input type="checkbox" name="is_special_offer" value="1" {{ old('is_special_offer') ? 'checked' : '' }} class="rounded border-gray-300 text-brand-red focus:ring-brand-red">
                    Special Offer
                </label>
                ...
                <label class="flex items-center gap-2 text-sm cursor-pointer">
                    <input type="checkbox" name="is_featured" value="1" {{ old('is_featured') ? 'checked' : '' }} class="rounded border-gray-300 text-brand-red focus:ring-brand-red">
                    Featured tab
                </label>
                <label class="flex items-center gap-2 text-sm cursor-pointer">
                    <input type="checkbox" name="is_on_sale" value="1" {{ old('is_on_sale') ? 'checked' : '' }} class="rounded border-gray-300 text-brand-red focus:ring-brand-red">
                    On Sale tab
                </label>
                <label class="flex items-center gap-2 text-sm cursor-pointer">
                    <input type="checkbox" name="is_top_rated" value="1" {{ old('is_top_rated') ? 'checked' : '' }} class="rounded border-gray-300 text-brand-red focus:ring-brand-red">
                    Top Rated tab
                </label>
            </div>
                ...
                <div class="max-h-48 overflow-y-auto space-y-1 pr-2 custom-scrollbar text-sm">
                    <template x-for="cat in categories" :key="cat.id">
                        <label class="flex items-center gap-2 cursor-pointer p-1 hover:bg-gray-50 rounded">
                            <input type="radio" :id="'cat_radio_' + cat.id" name="category_id" :value="cat.id" :checked="cat.id == {{ old('category_id', 'null') }}" class="text-brand-red bg-white border-gray-300 focus:ring-brand-red">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 space-y-5">
                <div>
                    ...
                    <div x-data="{ mainPreview: null, mainImageError: null }">
                        <input type="file" name="main_image" accept="image/*" 
                            @change="
                                mainImageError = null;
                                const f = $event.target.files[0];
                                if(!f) { mainPreview = null; return; }
                        ...
                        <div x-show="mainPreview" class="mt-2 text-center bg-gray-50 rounded border border-gray-200 p-2 min-h-[150px] flex items-center justify-center">
                ...
                <div>
                    ...
                    <div x-data="{
                        ...
                        <label class="block text-xs font-semibold text-gray-500 mb-1 uppercase">Upload Gallery Images</label>
                                ...
                                <div class="rounded border border-gray-200 p-2 bg-gray-50">
                                    <div class="flex gap-3 items-start">
                                        <div class="relative group w-20 h-20 shrink-0">
                                            <img :src="p.preview" class="w-20 h-20 object-cover rounded border border-gray-200 shadow-sm">
                        ...
                        <div x-show="previews.length === 0" class="text-xs text-gray-400 italic text-center mt-2">No gallery images added yet.</div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 space-y-3">
                ...
                <div class="flex gap-2 mb-1">
                    <input type="text" name="material" value="{{ old('material') }}" placeholder="e.g. Acrylic, PVC, Canvas" class="w-full border border-gray-200 rounded px-3 py-1.5 text-sm focus:border-brand-red outline-none">
                </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 space-y-3">
                ...
                <div class="text-xs text-gray-400 italic">Separate tags with commas</div>
...
<!-- Simple inline script for Alpine Component. Ideally in a separate JS file. -->
<script>
    document.addEventListener('alpine:init', () => {
        Alpine.data('categoryManager', () => ({
            ...
            async addCategory() {
                ...
                this.isAdding = true;
                try {
                    const res = await fetch('{{ route('admin.products.ajax.categories') }}', {
                        method: 'POST',
        ...
        Alpine.data('productForm', () => ({
            ...
            pageSettings: {
                hide_short_desc: false,
                hide_full_desc: false,
                hide_tier_pricing: false,
                hide_stock: false,
                hide_sku: false,
            ...
            async generateVariations() {
                ...
                try {
                    const response = await fetch('{{ route('admin.products.ajax.generate-variations') }}', {
                        method: 'POST',
                        headers: {
                    ...
                    if(data.variations) {
                        // Append or replace. We'll simply append new ones that don't exist.
            ...
            saveDraft() {
                // Change status to draft and submit form programmatically
...
<style>
/* Custom Scrollbar for max-height lists */
