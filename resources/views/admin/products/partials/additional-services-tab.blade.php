<div class="space-y-4">
    <div class="bg-gray-50 border border-gray-200 p-4 rounded-lg">
        ...
        <p class="text-xs text-gray-500 mt-1">Customers can select these on the product page (e.g. design together). Price is added per item to the cart.</p>
    </div>
    <div class="space-y-3">
        ...
        <button type="button" @click="additionalServices.push({ name: '', description: '', price: 0, is_active: true })" class="w-full border-2 border-dashed border-gray-300 text-gray-500 hover:text-brand-red hover:border-brand-red rounded-lg py-3 text-sm font-semibold transition bg-gray-50 hover:bg-white">
