...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-x-auto">
    <table class="w-full text-sm min-w-[960px]">
        ...
        <tbody class="divide-y divide-gray-50" id="products-homepage-table">
            ...
            @empty
                <tr><td colspan="9" class="px-4 py-10 text-center text-gray-400">No products yet. <a href="{{ route('admin.products.create') }}" class="text-brand-red hover:underline">Add one</a>.</td></tr>
            @endforelse
        </tbody>
    </table>
