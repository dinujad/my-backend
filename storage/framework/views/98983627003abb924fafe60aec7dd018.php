<?php $__env->startSection('title', 'WhatsApp Campaigns'); ?>
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
    <div class="p-6">
        <form method="POST" action="<?php echo e(route('admin.whatsapp.send')); ?>" enctype="multipart/form-data" class="space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                <textarea name="message" id="message" rows="5" class="w-full border border-gray-300 rounded-lg p-3 text-sm focus:ring-green-500 focus:border-green-500" placeholder="Type your WhatsApp message here..." required><?php echo e(old('message')); ?></textarea>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <a href="<?php echo e(route('admin.whatsapp.sample')); ?>" class="text-sm text-green-600 hover:text-green-800 font-medium flex items-center gap-1 transition">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\dev\printworks\backend\resources\views\admin\whatsapp\campaigns.blade.php ENDPATH**/ ?>