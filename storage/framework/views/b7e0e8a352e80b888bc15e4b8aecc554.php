...
<div x-data="productForm()" class="pb-20">
    ...
    <form x-ref="mainForm" action="<?php echo e(route('admin.products.store')); ?>" method="POST" enctype="multipart/form-data" class="flex flex-col lg:flex-row gap-6">
        <?php echo csrf_field(); ?>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 space-y-4">
                ...
                <div>
                    ...
                    <textarea name="description" rows="8"
                              class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:border-brand-red outline-none"><?php echo e(old('description')); ?></textarea>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="flex flex-col md:flex-row min-h-[400px]">
                    ...
                    <div class="flex-1 p-5 lg:p-6 bg-white space-y-5">
                        ...
                        <?php $allPaymentMethods = \App\Models\PaymentMethod::orderBy('sort_order')->get(); ?>
                            ...
                            <div class="space-y-2">
                                ...
                                <label class="flex items-center gap-3 cursor-pointer py-1">
                                    <input type="checkbox" name="payment_method_ids[]" value="<?php echo e($pm->id); ?>"
                                           <?php echo e(in_array($pm->id, old('payment_method_ids', [])) ? 'checked' : ''); ?>
        ...
        <div class="w-full lg:w-80 shrink-0 space-y-6">
                ...
                <div class="max-h-48 overflow-y-auto space-y-1 pr-2 custom-scrollbar text-sm">
                    <template x-for="cat in categories" :key="cat.id">
                        <label class="flex items-center gap-2 cursor-pointer p-1 hover:bg-gray-50 rounded">
                            <input type="radio" :id="'cat_radio_' + cat.id" name="category_id" :value="cat.id" :checked="cat.id == <?php echo e(old('category_id', 'null')); ?>" class="text-brand-red bg-white border-gray-300 focus:ring-brand-red">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 space-y-3">
                ...
                <div class="flex gap-2 mb-1">
                    <input type="text" name="material" value="<?php echo e(old('material')); ?>" placeholder="e.g. Acrylic, PVC, Canvas" class="w-full border border-gray-200 rounded px-3 py-1.5 text-sm focus:border-brand-red outline-none">
                </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\dev\printworks\backend\resources\views\admin\products\create.blade.php ENDPATH**/ ?>