            ...
            <div class="flex flex-col gap-1.5">
                ...
                <?php $__currentLoopData = $suggestions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button
                        ...
                        onclick="useSuggestion(<?php echo json_encode($s['text'], 15, 512) ?>)"
                    >
                        <i class="bi <?php echo e($s['icon']); ?> text-gray-400 group-hover:text-brand-red transition-colors w-4 text-center"></i>
                        <span class="text-gray-700 group-hover:text-gray-900"><?php echo e($s['text']); ?></span>
                    </button>
...
<script>
    ...
    const endpoint = <?php echo json_encode(route('admin.ai.chat.api'), 15, 512) ?>;
    const CSRF_TOKEN = <?php echo json_encode(csrf_token(), 15, 512) ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\dev\printworks\backend\resources\views\admin\ai\chat.blade.php ENDPATH**/ ?>